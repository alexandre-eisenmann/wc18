...
export default class Leaderboard extends Component {
  ...
  componentDidMount() {
    ...
    // Render instantly from the frozen-bids cache if we have it; the background
    // fetch below will refresh it. Scores are always recomputed from the live
    // results, so a slightly stale cache only affects who appears, not points.
