...
export default class Viz extends Component {
  ...
  render() {
    return  <div>
      <div id="viz" style={{margin: "auto", textAlign: "left", fontWeight: "bold", marginTop: "50px", paddingLeft: "50px", width: "340px", fontSize: "30px", fontFamily: "Roboto Condensed"}} >CHUVA DE PALPIPES </div>
