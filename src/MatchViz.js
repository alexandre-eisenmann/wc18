    ...
    return <svg viewBox="0 0 200 200"> 
              <g transform="translate(100,100) rotate(225 0 0)">
                  ...
                  {Object.keys(this.state.summary).map((key,i) => {
                    const r = this.state.summary[key]
                    ...
                    if (a != h) {
                      ...
                      return <g>
                        <path fill={"red"} key={i} d = {`M${a*unit-rr},${h*unit-rr} L${a*unit+rr},${h*unit+rr} A${r},${r} 0 1,0 ${a*unit-rr},${h*unit-rr} z`} opacity={0.5}/>
                        <path fill={"blue"} key={i} d = {`M${a*unit-rr},${h*unit-rr} L${a*unit+rr},${h*unit+rr} A${r},${r} 0 1,1 ${a*unit-rr},${h*unit-rr} z`}opacity={0.5} />
                      </g>
