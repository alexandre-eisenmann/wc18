...
const messages = {
  pt: {
    ...
    'home.daysUntilSimple': 'Faltam {count} dias para a Copa',
    'home.scroll': 'SCROLL',
    ...
    'bid.statusClosed': 'Apostas encerradas',
    'bid.closedBanner': 'As apostas estão encerradas! O primeiro jogo da Copa já vai começar. Não é mais possível criar ou editar palpites.',
    'bid.save': 'Salvar',
    ...
    'payment.loadHint': 'O sistema de pagamento está demorando para carregar. Se o botão continuar cinza, desative bloqueadores de anúncios/rastreadores e recarregue a página, ou tente em outro navegador (ex.: Chrome).',
    ...
    'rules.priceLabel': 'Valor por jogo:',
    ...
    'rules.score3': 'Resultado correto mas diferença de gols errada:',
  ...
  en: {
    ...
    'home.heroIntroEnd': '.',
    'home.playButton': 'PLAY',
    'home.daysUntilSimple': '{count} days until the World Cup',
    'home.scroll': 'SCROLL',
    ...
    'bid.statusClosed': 'Bids closed',
    'bid.closedBanner': 'Bids are closed! The first World Cup match is about to start. You can no longer create or edit predictions.',
    'bid.save': 'Save',
    ...
    'payment.loadHint': 'The payment system is taking a while to load. If the button stays greyed out, disable ad/tracker blockers and reload the page, or try another browser (e.g. Chrome).',
    ...
    'rules.title': 'Rules',
    'rules.priceLabel': 'Price per bid:',
    'rules.priceEstimateNote': 'estimate',
    ...
    'rules.score3': 'Correct result but wrong goal difference:',
